# Tituscore Wallet Client

## Description

This package communicates with TWS Tituscore wallet service using the REST API. All REST endpoints are wrapped as simple async methods. All relevant responses from TWS are checked independently by the peers, thus the importance of using this library when talking to a third party TWS instance.
